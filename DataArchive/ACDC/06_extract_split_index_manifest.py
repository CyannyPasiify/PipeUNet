...
"""
Dataset Split Index Manifest Extraction Script for ACDC Dataset
...
def process_split_index_manifest(manifest_file, split_name, output_index_manifest_dir, subset_groups):
    ...
    try:
        df = pd.read_excel(manifest_path, sheet_name=split_name, dtype={'ID': str, 'patient': str, 'frame': str})
