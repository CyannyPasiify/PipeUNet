...
from typing import TypeVar, Optional, Union, Tuple, List, Dict, Callable, Sequence, Literal, Any
...
class ConfigLossFocal(ConfigLossBase):
    ...
    weight: Optional[Union[TLSeq[float], float, int, torch.Tensor]] = None
...
class ConfigLossDeepSupervisionDice(ConfigLossDeepSupervision):
    ...
    def init_essentials(self) -> 'ConfigLossDeepSupervisionDice':
        ...
        self.loss: mL.DeepSupervisionLoss = mL.DeepSupervisionLoss(
            loss=self.base_loss,
            weight_mode=self.ds_weight_mode,
...
class ConfigLossPerceptual(ConfigLossBase):
    ...
    def init_essentials(self) -> 'ConfigLossPerceptual':
        self.loss: mL.PerceptualLoss = mL.PerceptualLoss(
            ...
            pretrained_state_dict_key=self.pretrained_state_dict_key,
